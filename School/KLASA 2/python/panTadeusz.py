...
--------------------------------------------
"""
print("STATYSTYKI WYSTĘPOWANIA SŁÓW:")
print("PAN TADEUSZ:",PanTadeusz.count("Pan Tadeusz"))
print("TADEUSZ:",PanTadeusz.count("Tadeusz"))
print("TADEUSZU:",PanTadeusz.count("Tadeuszu"))
print("TADEUSZA:",PanTadeusz.count("Tadeusza"))

iloscSlow=0

for slowa in PanTadeusz:
    if slowa == " ":
        continue
    else:
        iloscSlow+=1

print("W TEKSCIE WYSTĘPUJE",iloscSlow,"LITER")